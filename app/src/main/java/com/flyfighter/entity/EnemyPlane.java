...
public class EnemyPlane extends Spirit {
    ...
    public static final int[][] enemyData = new int[][]{{1, 4, 1, 0, 0, 20, 0, 12, 0, 0, 0, 0, 156, 38, 2, 4, 3},
            ...
            {201, 1, 22, 0, 4, 4, 60, 5000, 0, 170, 0, 0, 6688, 40, 0, 0, 8},
            {202, 1, 25, 0, 4, 4, 60, 5000, 0, 170, 0, 0, 6686, 40, 0, 0, 8},
            {203, 1, 25, 0, 6, 6, 60, 5000, 0, 170, 0, 0, 6886, 40, 0, 0, 8},
            {204, 1, 28, 0, 6, 6, 60, 7000, 0, 170, 0, 0, 8888, 40, 0, 0, 8},
            {205, 1, 30, 0, 8, 8, 60, 9000, 0, 170, 0, 0, 9999, 40, 0, 0, 8}};
